...
public class FillinDetails implements ActionListener{
    ...
    public FillinDetails() {
        
        f = new JFrame("Second hand books");
        ...
        id15.setLayout(null);
        id15.setBackground(Color.BLACK);
        ...
        id8 = new JLabel("SECOND HAND BOOKS");
     ...
     public void actionPerformed(ActionEvent ae){
        ...
        if (ae.getSource() == b){
            ...
            try{
                Conn cc = new Conn();
                String q = "insert into books values('"+a+"','"+bb+"','"+c+"','"+d+"')";
                cc.s.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"books Details Inserted Successfully");
                f.setVisible(false);
